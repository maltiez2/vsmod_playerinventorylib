...
public class InventoryPlayerBackpacksPlayerInventoryLib : InventoryPlayerBackpacks
{
    public BagInventory BagInventory => bagInv;
    public ItemSlot[] BackpackSlots => bagSlots;

    public InventoryPlayerBackpacksPlayerInventoryLib(string className, string playerUID, ICoreAPI api) : base(className, playerUID, api)
    {
        _api = api;
    }

    public InventoryPlayerBackpacksPlayerInventoryLib(string inventoryId, ICoreAPI api) : base(inventoryId, api)
    {
        _api = api;
    }
